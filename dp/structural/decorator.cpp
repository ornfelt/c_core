...
/**
	...
	Usage examples: The Decorator is pretty standard in C++ code, especially in code
	related to streams.

	Identification: Decorator can be recognized by creation methods or constructors that
