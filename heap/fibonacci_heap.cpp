...
/**
	A fibonacci heap is a data structure that consists of a collection of trees which
	follow min heap or max heap property. We have already discussed min heap and max heap
	...
	- It is a set of min heap-ordered trees. (i.e. The parent is always smaller than the
	children.)
	...
	parent node are connected to each other through a circular doubly linked list as shown
	below.
