...
/**
	...
	Change the value of a specified element of the array to a new value x. We need to do
	arr[i] = x where 0 <= i <= n-1.

	Sum of range using Segment Tree :
	The most efficient way is to use a segment tree, we can use a Segment Tree to do both
