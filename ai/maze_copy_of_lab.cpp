...
void *genRandomState(int *state)
{
	...
	/* vector<int> elementVector = {3, 2, 1, 1, 1, 1}; */
...
int main() {
	...
	/* while (!isSolveable(currentEnv[0])) genRandomState(currentEnv[0]); */
	...
	MazeGame maze(currentEnv[0]);
	Robot robot(currentEnv[0], 1.0);
