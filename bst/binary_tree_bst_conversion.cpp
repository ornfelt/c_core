...
/**
	...
	Sort the temp array arr[]. Time complexity of this step depends upon the sorting
	...
	Time Complexity: O(nlogn). This is the complexity of the sorting algorithm which we
	are using after first in-order traversal, rest of the operations take place in linear
	time.
...
int main()
{
	...
	cout <<"Inorder Traversal of the converted BST:" << endl ;
	printInorder(root);
