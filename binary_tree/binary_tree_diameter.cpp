...
/**
	...
	the ends of the longest path are shaded (note that there is more than one path in each
	...
	recursion rather than calling a height() separately. Thanks to Amar for suggesting
